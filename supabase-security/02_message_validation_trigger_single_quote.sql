-- TextLinker Supabase setup, chunk 02 single-quote version.
-- Use this if Supabase SQL Editor keeps breaking dollar-quoted function bodies.
-- IMPORTANT: Paste this whole file into a new blank SQL query.
-- If Supabase shows the RLS popup, click "Run without RLS".
-- Do not click "Run and enable RLS". Do not click "Debug with Assistant".
